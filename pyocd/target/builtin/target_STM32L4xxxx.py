...
class STM32L4xxxx(CoreSightTarget):
        
    VENDOR = "STMicroelectronics"
 
    def create_init_sequence(self):
        seq = super(STM32L4xxxx, self).create_init_sequence()
...
class STM32L4xxxB(STM32L4xxxx):

    memoryMap = MemoryMap(
        FlashRegion(name='flash', start=0x08000000, length=0x20000, blocksize=0x800,  is_boot_memory=True,
            algo=FLASH_ALGO),
    ...
    def __init__(self, transport):
        super(STM32L4xxxB, self).__init__(transport, self.memoryMap)
        # cmsis-svd doesn't have this device's SVD file

class STM32L4xxxC(STM32L4xxxx):
    ...
    def __init__(self, transport):
        super(STM32L4xxxC, self).__init__(transport, self.memoryMap)
        # cmsis-svd doesn't have this device's SVD file

class STM32L4xxxE(STM32L4xxxx):
    ...
    def __init__(self, transport):
        super(STM32L4xxxE, self).__init__(transport, self.memoryMap)
        # cmsis-svd doesn't have this device's SVD file

class STM32L4xxxG(STM32L4xxxx):
    ...
    def __init__(self, transport):
        super(STM32L4xxxG, self).__init__(transport, self.memoryMap)
        # cmsis-svd doesn't have this device's SVD file
