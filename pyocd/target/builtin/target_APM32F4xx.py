...
MEMORY_MAP_APM32F405XG = MemoryMap(
    ...
    FlashRegion(start=0x08010000, length=0x10000, sector_size=0x10000, page_size=0x400,
        algo=FLASH_ALGO),
    FlashRegion(start=0x08020000, length=0xE0000, sector_size=0x20000, page_size=0x400,
        algo=FLASH_ALGO),
    RamRegion(start=0x20000000, length=0x20000),
    RamRegion(start=0x10000000, length=0x10000),
)

MEMORY_MAP_APM32F465XE = MemoryMap(
    FlashRegion(start=0x08000000, length=0x10000, sector_size=0x4000, page_size=0x400,
        is_boot_memory=True, algo=FLASH_ALGO),
    FlashRegion(start=0x08010000, length=0x10000, sector_size=0x10000, page_size=0x400,
        algo=FLASH_ALGO),
...
MEMORY_MAP_APM32F407XG = MemoryMap(
    FlashRegion(start=0x08000000, length=0x10000, sector_size=0x4000, page_size=0x400,
        is_boot_memory=True, algo=FLASH_ALGO),
    FlashRegion(start=0x08010000, length=0x10000, sector_size=0x10000, page_size=0x400,
        algo=FLASH_ALGO),
...
MEMORY_MAP_APM32F427XG = MemoryMap(
    FlashRegion(start=0x08000000, length=0x10000, sector_size=0x4000, page_size=0x400,
        is_boot_memory=True, algo=FLASH_ALGO),
    FlashRegion(start=0x08010000, length=0x10000, sector_size=0x10000, page_size=0x400,
        algo=FLASH_ALGO),
...
class _APM32F4xxFamily(CoreSightTarget):
    VENDOR = "Geehy"
...
class APM32F405xG(_APM32F4xxFamily):
    MEMORY_MAP = MEMORY_MAP_APM32F405XG

    def __init__(self, session):
        super().__init__(session, self.MEMORY_MAP)


class APM32F407xG(_APM32F4xxFamily):
    MEMORY_MAP = MEMORY_MAP_APM32F407XG

    def __init__(self, session):
        super().__init__(session, self.MEMORY_MAP)


class APM32F415xG(_APM32F4xxFamily):
    MEMORY_MAP = MEMORY_MAP_APM32F405XG
...
class APM32F417xG(_APM32F4xxFamily):
    MEMORY_MAP = MEMORY_MAP_APM32F407XG
...
class APM32F427xG(_APM32F4xxFamily):
    MEMORY_MAP = MEMORY_MAP_APM32F427XG

    def __init__(self, session):
        super().__init__(session, self.MEMORY_MAP)


class APM32F465xE(_APM32F4xxFamily):
    # User confirmed APM32F465 can directly reuse the 1024KB family flash algorithm.
    MEMORY_MAP = MEMORY_MAP_APM32F465XE
