...
class Flash_stm32f429xx(Flash):
    ...
    def __init__(self, target):
        super(Flash_stm32f429xx, self).__init__(target, FLASH_ALGO)

    def get_flash_info(self):
        info = super(Flash_stm32f429xx, self).get_flash_info()
...
class STM32F429xG(CoreSightTarget):
    ...
    memoryMap = MemoryMap(
        FlashRegion( start=0x08000000, length=0x10000, blocksize=0x4000,  is_boot_memory=True,
            flash_class=Flash_stm32f429xx),
        FlashRegion( start=0x08010000, length=0x10000, blocksize=0x10000, flash_class=Flash_stm32f429xx),
        FlashRegion( start=0x08020000, length=0x60000, blocksize=0x20000, flash_class=Flash_stm32f429xx),
...
class STM32F429xI(CoreSightTarget):
    ...
    memoryMap = MemoryMap(
        FlashRegion( start=0x08000000, length=0x10000, blocksize=0x4000,  is_boot_memory=True,
            flash_class=Flash_stm32f429xx),
        FlashRegion( start=0x08010000, length=0x10000, blocksize=0x10000, flash_class=Flash_stm32f429xx),
        FlashRegion( start=0x08020000, length=0xe0000, blocksize=0x20000, flash_class=Flash_stm32f429xx),
        FlashRegion( start=0x08100000, length=0x10000, blocksize=0x4000, flash_class=Flash_stm32f429xx),
        FlashRegion( start=0x08110000, length=0x10000, blocksize=0x10000, flash_class=Flash_stm32f429xx),
        FlashRegion( start=0x08120000, length=0xe0000, blocksize=0x20000, flash_class=Flash_stm32f429xx),
