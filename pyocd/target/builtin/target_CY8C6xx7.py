...
class Flash_CY8C6xx7_Main(PSoC6FlashCommon):
    def __init__(self, target):
        super(Flash_CY8C6xx7_Main, self).__init__(target, flash_algo_main)


class Flash_CY8C6xx7_Work(PSoC6FlashCommon):
    def __init__(self, target):
        super(Flash_CY8C6xx7_Work, self).__init__(target, flash_algo_work)


class Flash_CY8C6xx7_SFlash(PSoC6FlashCommon):
    def __init__(self, target):
        super(Flash_CY8C6xx7_SFlash, self).__init__(target, flash_algo_sflash)
...
class CY8C6xx7(CoreSightTarget):
    ...
    memoryMap = MemoryMap(
        ...
        FlashRegion(start=0x16000000, length=0x8000, blocksize=0x200, is_boot_memory=False, erased_byte_value=0,
                    is_testable=False, algo=flash_algo_sflash, flash_class=Flash_CY8C6xx7_SFlash),
