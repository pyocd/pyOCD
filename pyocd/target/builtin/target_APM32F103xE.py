...
class _APM32F103xEFamily(CoreSightTarget):
    VENDOR = "Geehy"
...
class APM32F103xC(_APM32F103xEFamily):
    # Covers APM32F103CC/RC/VC/ZC
    MEMORY_MAP = MemoryMap(
        FlashRegion(start=0x08000000, length=0x40000, blocksize=0x400, page_size=0x800,
...
class APM32F103xE(_APM32F103xEFamily):
    # Covers APM32F103RE/VE/ZE
    MEMORY_MAP = MemoryMap(
        FlashRegion(start=0x08000000, length=0x80000, blocksize=0x400, page_size=0x800,
            is_boot_memory=True, algo=FLASH_ALGO),
