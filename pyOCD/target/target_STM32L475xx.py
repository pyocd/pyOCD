...
class STM32L475xC(STM32L475xx):
    ...
    memoryMap = MemoryMap(
        FlashRegion(name='flash', start=0x08000000, length=0x40000, blocksize=0x800,  isBootMemory=True),
...
class STM32L475xE(STM32L475xx):
    ...
    memoryMap = MemoryMap(
        FlashRegion(name='flash', start=0x08000000, length=0x80000, blocksize=0x800,  isBootMemory=True),
        RamRegion(name='sram1',   start=0x20000000, length=0x18000),
        RamRegion(name='sram2',   start=0x10000000, length=0x8000)
        )
...
class STM32L475xG(STM32L475xx):
    ...
    memoryMap = MemoryMap(
        FlashRegion(name='flash', start=0x08000000, length=0x100000, blocksize=0x800,  isBootMemory=True),
        RamRegion(name='sram1',   start=0x20000000, length=0x18000),
        RamRegion(name='sram2',   start=0x10000000, length=0x8000)
        )
